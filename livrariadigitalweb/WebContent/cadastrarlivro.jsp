			...
			<div class="row">
				...
				<div class="form-group col-md-4">
					<label for="exampleInputEmail1">Autor</label> <input type="text"
						name="autor" class="form-control" id="exampleInputEmail1"
						placeholder="Digite o valor">
				</div>
				<div class="form-group col-md-4">
					<label for="exampleInputEmail1">Editora</label> <input type="text"
						name="editora" class="form-control" id="exampleInputEmail1"
						placeholder="Digite o valor">
				</div>
			</div>
